    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jam_pulang', models.TimeField(null=True)),
                ('jam_istirahat', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jabatan_sebelum', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='jabatan_sebelum', to='hrd_app.jabatan_db')),
                ('jabatan_sekarang', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='jabatan_setelah', to='hrd_app.jabatan_db')),
                ('pegawai', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hrd_app.pegawai_db')),
            ],
            options={
