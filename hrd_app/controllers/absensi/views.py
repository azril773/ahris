...
def pabsen(request):    
    ...
    # print([a for a in att if a["userid"] == '201005'],"print")
    if not att:
        pass
    else:
        for a in att:
...
# ++++++++++++++++++++++++++++++++++++++++  PULANG MALAM  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    # data absensi
    print(next((True for o in opg_all if o["idp"] == ab.pegawai_id and o["opg_tgl"] == ab.tgl_absen and o["keterangan"] == "OFF Pengganti Reguler"),False))
    if int(sid) == 0:
    ...
    for a in data:
        ...
        if (ab.masuk is not None and ab.pulang is not None) or (ab.masuk_b is not None and ab.pulang_b is not None):
            print(a.pegawai,a.pegawai.hari_off,nh)
